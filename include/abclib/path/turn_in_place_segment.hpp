...
namespace abclib::path
{
    ...
    public:
         ...
         */
        TurnInPlaceSegment(const Pose &center_pose, double end_heading, units::Length track_width);
        ...
        units::Length get_track_width() const { return track_width_; }
        bool is_turn_in_place() const override { return true; }
        double get_turning_radius() const { return track_width_.to_inches() / 2.0; }
